...
This is a good model, although very slow.
...
Runs fine with the fist smaller data set, and with the small data set.  No feature importance unfortunately, although the "finalmodel" does give detail of the coefficients used.
...
Performed well, but slowly with the smaller data set, though.
...
This indicates that the top 23 or 28 features have the biggest impact on the overall RMSE, so if we had to cut off, it would be around the 28 features number.
